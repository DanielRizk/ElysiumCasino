package org.daniel.elysium.games.ultimateTH.models;
 ...
 * Each {@code UTHCardUI} is linked to a logical {@link UthCard} instance.
 */
public class UthCardUI extends UICard {

    /** The logical backend representation of an ultimate_th card. */
    private final UthCard card;

    /**
     * Constructs a {@code UTHCardUI} with a given rank, suit, and image asset.
     *
     ...
     */
    public UthCardUI(String rank, String suit, Asset icon) {
        super(rank, suit, icon);
        card = new UthCard(rank, suit);
    }
     ...
     *
     * @return The corresponding {@link UthCard} instance.
     */
    public UthCard getCard() {
        return card;
    }
